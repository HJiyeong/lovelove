...
function Sidebar() {
  return (
    <aside className="w-64 bg-gradient-to-b from-[#ffd9e0] via-[#f5d5f3] to-[#d9e4ff] p-6 shadow-xl text-black flex flex-col justify-between rounded-tr-3xl rounded-br-3xl py-10">
      ...
      <div>
        ...
        <div className="text-[15px] text-black text-left leading-snug px-3 py-10 mb-6 space-y-2">
          <div>
        ...
        <nav className="flex flex-col gap-3 py-20">
          {["메인", "연애 고수의 조언", "데이트 장소", "나의 다이어리"].map((label, idx) => (
            <Link
              key={idx}
              to={['/', '/search', '/dateplace', '/calendar'][idx]}
