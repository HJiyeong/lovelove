...
public class OpenAiService {
    ...
    public String askChatGpt(List<ChatMessage> history) {
        ...
        messages.add(Map.of(
                "role", "system",
                "content",
                "너는 행동주의 치료에 입각한 연애 상담 선생 님이야. 솔로의 연애의지와 자신감회복이 너의 목표야. 내담자의 이야기를 경청해. 내담자의 감정이나 상태에 대해 판단하지마. 내담자가 더 많은 이야기를 할 수있도록 유도 해. 내담자가 어떤 고민이 있는지 물어보며 대화 를 시작해. 대답은 한 문단으로만 해."
                        +"대화를 기억해 맥락을 이어가세요."
        ));
